...
namespace MyHotel.Api.Controllers
{
    ...
    public class RoomsController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> Put(int id, [FromBody] RoomPostModel r)
        {
            ...
            //if (r.Type != 'A' && r.Type != 'B' && r.Type != 'C' || r.Price <= 0 || r.NumBeds <= 0)
            //    return BadRequest();
            Room r1 = await _roomService.GetRoomByIdAsync(id);
            _mapper.Map(r,r1);
            await _roomService.UpdateRoomAsync(id, r1);
            return Ok();
        }
